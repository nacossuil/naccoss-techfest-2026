    ...
    <nav className="fixed top-0 w-full z-50 bg-[#0a0a0a]/80 backdrop-blur-md border-b border-white/10">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3 sm:gap-4 hover:opacity-80 transition-opacity">
          ...
          <div className="relative w-10 h-10 flex-shrink-0">
            <Image 
              src="/nacoss-logo.png" // Replace with your actual path in the public folder
              alt="NACOSS Logo" 
              fill
              className="object-contain"
            />
          ...
          <div className="relative w-10 h-10 flex-shrink-0">
            <Image 
              src="/nacoss-nova-logo-2.png" // Replace with your actual path in the public folder
              alt="TechFest Logo" 
              fill
              className="object-contain"
            />
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-300">
          ...
          <Link href="#speakers" className="hover:text-cyan-400 transition-colors">Speakers</Link>
